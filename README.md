...
❗Before reporting a problem, be sure to try the latest [beta version](https://github.com/plusls/oh-my-minecraft-client/actions) to check if the problem still exists.
